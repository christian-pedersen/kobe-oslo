...
In order to get the theoretical potential of the spacecraft($\Phi_d$), we need the ion, electron and photoelectron current (\(I_e\), )
\begin{equation}
\begin{split}
 I_i = &
...
\begin{figure}
	...
	\caption{Figures of the experimental set up.}
    \end{figure}
