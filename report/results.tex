...
\begin{figure}
    ...
    \caption{Potential of satellite and surroundings in the x-direction for case 1 and case 4. Note that the potential drop i much greater in the right probe when comparing the two cases.}
...
\begin{figure}
    \centering
    \includegraphics[width = 0.6 \textwidth]{images/pot_case25.png}
...
\begin{figure}
    \centering
    \includegraphics[width = 0.6 \textwidth]{images/pot_case36.png}
