...
Comparing the two cases we have a rather large drop in potential of 12\% on the left probe. We see that we have about the same potential drop value on the right side but the change is only 3\% when comparing the cases. Potential rise of 26\% over the satelite.
